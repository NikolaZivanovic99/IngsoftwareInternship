...
namespace MovieLibrary.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Occupations= await _userService.GetOccupations();
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ApplicationUser {FirstName=Input.FirstName,LastName=Input.LastName,Address=Input.Address,IdNumber=Input.IdNumber,Email=Input.Email,OccupationId=Input.OccupationId,InsertDate=DateTime.Now };
